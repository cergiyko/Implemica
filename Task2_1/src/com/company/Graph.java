...
class Graph {
        ...
        private Map<String, Integer> cityList = new HashMap<String, Integer>(); // List of cities
        ...
        public void addEdge( int nr, int cost) {
             ...
             void dijkstra(String start, String finish) {
                 ...
                 for (int i = 0; i <= n; i++) {
                    ...
                    //result output
        System.out.println("The minimum transportation cost from city " + start + " to city " + finish + " = " + pathCost[cityList.get(finish)]);
                     System.out.println();
                     }
                 }
